// Lexicorp per-game configuration.
//
...
export const GAME_SLUG = 'lexicorp';
export const GAME_NAME = 'Lexicorp';

// VAPID public key for Web Push — the same project-wide key every LB Games
// title uses (the private half is a Supabase Edge Function secret).
